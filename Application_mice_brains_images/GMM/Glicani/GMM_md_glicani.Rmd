...
```{r}
G12 = ggplot(data = df,aes(x = pca1,y = pca2,color = as.factor(allocGMM))) + geom_point(alpha = 0.2) + scale_colour_viridis_d(option = "D") + theme(legend.position = "bottom") +   labs(color = "cluster") + theme(legend.position = "none")

G13 = ggplot(data = df,aes(x = pca1,y = pca3,color = as.factor(allocGMM))) + geom_point(alpha = 0.2) + scale_colour_viridis_d(option = "D") + theme(legend.position = "bottom") +   labs(color = "cluster") + theme(legend.position = "none")

G14 = ggplot(data = df,aes(x = pca1,y = pca4,color = as.factor(allocGMM))) + geom_point(alpha = 0.2) + scale_colour_viridis_d(option = "D") + theme(legend.position = "bottom") +  labs(color = "cluster") + theme(legend.position = "none")

G23 = ggplot(data = df,aes(x = pca2,y = pca3,color = as.factor(allocGMM))) + geom_point(alpha = 0.2) + scale_colour_viridis_d(option = "D") + theme(legend.position = "bottom") +  labs(color = "cluster") + theme(legend.position = "none")

G24 = ggplot(data = df,aes(x = pca2,y = pca4,color = as.factor(allocGMM))) + geom_point(alpha = 0.2) + scale_colour_viridis_d(option = "D") + theme(legend.position = "bottom") +  labs(color = "cluster") + theme(legend.position = "none")

G34 = ggplot(data = df,aes(x = pca3,y = pca4,color = as.factor(allocGMM))) + geom_point(alpha = 0.2) + scale_colour_viridis_d(option = "D") + theme(legend.position = "bottom") +  labs(color = "cluster") + theme(legend.position = "none")
...
(G12 | G23) / (G13 | G24) / (G14 | G34)
ggsave("glicani_GMM3b.png",width = 20,units = "cm")
```
...
(G12 | G23) / (G13 | G24) / (G14 | G34)
ggsave("glicani_GMM4b.png",width = 20,units = "cm")
```
...
G12 / G13
ggsave("glicani_GMM4c.png",width = 20,units = "cm")
```


```{r}
G23 / G24 
ggsave("glicani_GMMd4d.png",width = 20,units = "cm")
```

```{r}
G14 / G34
ggsave("glicani_GMMd4e.png",width = 20,units = "cm")
```
...
ggplot(data = muchain,aes(x = index,y = mu,color = as.factor(cluster))) + geom_line() + scale_colour_viridis_d(option = "H") + facet_wrap(~comp,scales = "free") + theme(legend.position = "bottom") + labs(color = "cluster")
ggsave("glicani_GMM6muchain.png",width = 20,units = "cm")
```
...
ggplot(data = sigmachain,aes(x = index,y = sigma,color = as.factor(cluster))) + geom_line() + scale_colour_viridis_d(option = "H") +
  theme(legend.position = "bottom") + facet_wrap(~comp,scales = "free") + labs(color = "cluster")
ggsave("glicani_GMM6sigma.png",width = 20,units = "cm")
```
...
ggplot(data = wchain,aes(x = index,y = w,color = as.factor(cluster))) + geom_line() + scale_colour_viridis_d(option = "H")  +
  theme(legend.position = "bottom") + labs(color = "cluster")
ggsave("glicani_GMM6wchain.png",width = 10,units = "cm")
```
...
G12 / G13
ggsave("glicani_GMM6b.png",width = 20,units = "cm")
```


```{r}
G23 / G24 
ggsave("glicani_GMM6c.png",width = 20,units = "cm")
```

```{r}
G14 / G34
ggsave("glicani_GMM6d.png",width = 20,units = "cm")
```
...
```{r}
(G12 | G23) / (G13 | G24) / (G14 | G34)
ggsave("glicani_GMM6e.png",width = 20,units = "cm")
```

```{r}
G1 = ggplot(data = df,aes(x = pca1,color = as.factor(allocGMM6), fill = as.factor(alloc),after_stat(density))) + geom_histogram(bins = 100,alpha = 0,linewidth = 0.7) + geom_density(linewidth = 1.2)  + scale_colour_viridis_d(option = "H") + scale_fill_viridis_d(option = "H",alpha = 0.3) + theme(legend.position = "bottom") + labs(color = "cluster", fill = "cluster")

G2 = ggplot(data = df,aes(x = pca2,color = as.factor(allocGMM6), fill = as.factor(alloc),after_stat(density))) + geom_histogram(bins = 100,alpha = 0,linewidth = 0.7) + geom_density(linewidth = 1.2)  + scale_colour_viridis_d(option = "H") + scale_fill_viridis_d(option = "H",alpha = 0.3) + theme(legend.position = "bottom") + labs(color = "cluster", fill = "cluster")

G3 = ggplot(data = df,aes(x = pca3,color = as.factor(allocGMM6), fill = as.factor(alloc),after_stat(density))) + geom_histogram(bins = 100,alpha = 0,linewidth = 0.7) + geom_density(linewidth = 1.2)  + scale_colour_viridis_d(option = "H") + scale_fill_viridis_d(option = "H",alpha = 0.3) + theme(legend.position = "bottom") + labs(color = "cluster", fill = "cluster")

G4 = ggplot(data = df,aes(x = pca4,color = as.factor(allocGMM6), fill = as.factor(alloc),after_stat(density))) + geom_histogram(bins = 100,alpha = 0,linewidth = 0.7) + geom_density(linewidth = 1.2)  + scale_colour_viridis_d(option = "H") + scale_fill_viridis_d(option = "H",alpha = 0.3) + theme(legend.position = "bottom") + labs(color = "cluster", fill = "cluster")
...
G13a <- ggMarginal(G13,type = "density",groupColour = TRUE, groupFill = TRUE)

G14 = ggplot(data = df,aes(x = pca1,y = pca4,color = as.factor(allocGMM6))) + geom_point(alpha = 0.2) + scale_colour_viridis_d(option = "H") + theme(legend.position = "bottom") +  stat_ellipse(linewidth = 1) + labs(color = "cluster") + theme(legend.position = "none")

G14a <- ggMarginal(G14,type = "density",groupColour = TRUE, groupFill = TRUE)

G23 = ggplot(data = df,aes(x = pca2,y = pca3,color = as.factor(allocGMM6))) + geom_point(alpha = 0.2) + scale_colour_viridis_d(option = "H") + theme(legend.position = "bottom") +  stat_ellipse(linewidth = 1) + labs(color = "cluster") + theme(legend.position = "none")

G23a <- ggMarginal(G23,type = "density",groupColour = TRUE, groupFill = TRUE)

G24 = ggplot(data = df,aes(x = pca2,y = pca4,color = as.factor(allocGMM6))) + geom_point(alpha = 0.2) + scale_colour_viridis_d(option = "H") + theme(legend.position = "bottom") +  stat_ellipse(linewidth = 1)  + labs(color = "cluster") + theme(legend.position = "none")

G24a <- ggMarginal(G24,type = "density",groupColour = TRUE, groupFill = TRUE)

G34 = ggplot(data = df,aes(x = pca3,y = pca4,color = as.factor(allocGMM6))) + geom_point(alpha = 0.2) + scale_colour_viridis_d(option = "H") + theme(legend.position = "bottom") +  stat_ellipse(linewidth = 1) + labs(color = "cluster") + theme(legend.position = "none")

G34a <- ggMarginal(G34,type = "density",groupColour = TRUE, groupFill = TRUE)


G12a
ggsave("glicani_GMM6f.png",width = 20,units = "cm")

G13a
ggsave("glicani_GMM6g.png",width = 20,units = "cm")

G14a
ggsave("glicani_GMM6h.png",width = 20,units = "cm")

G24a
ggsave("glicani_GMM6i.png",width = 20,units = "cm")

G23a
ggsave("glicani_GMM6l.png",width = 20,units = "cm")

G34a
ggsave("glicani_GMM6m.png",width = 20,units = "cm")
```